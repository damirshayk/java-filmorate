...
- `friendships` хранит направленное добавление одного пользователя в друзья к другому.

Дружба не становится взаимной автоматически. Если второй пользователь тоже добавит первого в друзья, в `friendships` появится отдельная запись с обратным направлением.
